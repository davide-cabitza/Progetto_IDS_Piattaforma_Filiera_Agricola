...
public class ProdottoDistributore extends Prodotto {
    ...
    public ProdottoDistributore(int id, String nomeProdotto, String descrizione, String certificati, double costo, int quantitativo, int id_venditore, Date dataInserimento) {
